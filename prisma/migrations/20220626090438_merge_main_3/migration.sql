/*
  ...
  - You are about to drop the `arrears_settings` table. If the table is not empty, all the data it contains will be lost.
...
-- DropTable
DROP TABLE "arrears_settings";

-- CreateTable
CREATE TABLE "product_arrears_settings" (
    "id" SERIAL NOT NULL,
    ...
    CONSTRAINT "product_arrears_settings_pkey" PRIMARY KEY ("id")
);

-- AddForeignKey
ALTER TABLE "loan_products" ADD CONSTRAINT "loan_products_arrears_settings_id_fkey" FOREIGN KEY ("arrears_settings_id") REFERENCES "product_arrears_settings"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
